...
# Exemple d'une observation unique :
une_observation <- africa_data[1, ]
print(paste("Exemple d'observation :", une_observation$fnid, "-", 
            une_observation$admin_1, "-", 
            une_observation$product, "-", 
            une_observation$season_name))
