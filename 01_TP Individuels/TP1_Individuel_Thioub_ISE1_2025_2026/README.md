# Projet Google Earth Engine : Analyse spatiale du paludisme  au Cameroun
...
Ce projet s’inscrit dans le cadre du travail pratique d’initiation à Google Earth Engine (GEE) en JavaScript, proposé dans le cours de Statistiques Exploratoires et Spatiales. Il a pour objectif de familiariser l’étudiant avec l’importation, la manipulation et la visualisation de données raster et vectorielles. À travers l’analyse conjointe de la population et du paludisme, l’étude explore la dynamique spatiale et temporelle de ces phénomènes sur le territoire camerounais.
...
```
TP1_Individuel_Thioub_ISE1_2025_2026/
│
├── Données/
